...
export default async function ActionSummary({ data }: { data: DashboardData }) {
  ...
  return (
    <div className="mt-4 rounded-lg bg-indigo-50/60 dark:bg-indigo-950/20 border border-indigo-200/70 dark:border-indigo-900/40 px-4 py-3">
      <p className="text-sm font-semibold text-indigo-900 dark:text-indigo-200">{summary.headline}</p>
