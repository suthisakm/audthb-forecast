...
export default async function ActionSummary({ data }: { data: DashboardData }) {
  ...
  return (
    <div className="mt-4 rounded-lg bg-sky-50/60 dark:bg-sky-950/20 border border-sky-200/70 dark:border-sky-900/40 px-4 py-3">
      <p className="text-sm font-semibold text-sky-900 dark:text-sky-200">{summary.headline}</p>
