  ...
  return (
    <span className="relative inline-flex items-center group">
      <button
        ...
        className="ml-1 inline-flex h-3.5 w-3.5 shrink-0 items-center justify-center rounded-full border border-slate-400 dark:border-slate-600 text-[9px] leading-none text-slate-600 dark:text-slate-400 hover:border-slate-600 dark:hover:border-slate-400 hover:text-slate-700 dark:hover:text-slate-300 focus:outline-none focus-visible:ring-2 focus-visible:ring-sky-500 focus-visible:ring-offset-1 focus-visible:ring-offset-slate-50 dark:focus-visible:ring-offset-slate-800"
      >
        i
      </button>

      <span
        className={`pointer-events-none absolute bottom-full left-1/2 z-50 mb-2 w-56 -translate-x-1/2 rounded-lg border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 p-2.5 text-xs font-normal normal-case tracking-normal leading-relaxed text-slate-700 dark:text-slate-300 shadow-xl transition-opacity ${
