...
export default function StickyBar({
  ...
  return (
    ...
    >
      <div className="border-b border-slate-200 dark:border-slate-800 bg-slate-50/90 dark:bg-slate-950/90 backdrop-blur">
        <div className="h-0.5 bg-sky-700 dark:bg-sky-400" />
